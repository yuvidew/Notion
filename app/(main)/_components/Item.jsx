...
export const Item = ({
    ...
    return (
        ...
        >
            ...
            {isSearch && (
                <kbd className="  ml-auto pointer-events-none inline-flex h-5 select-none item-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">
